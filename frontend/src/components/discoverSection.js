...
const DiscoverSection = ({ discoverChapters }) => {
    const safeDiscoverChapters = Array.isArray(discoverChapters) ? discoverChapters : [];
    ...
    return (
        <div className="quiz-section p-3">
            {safeDiscoverChapters.map((subject, index) => (
                    ...
                    <Card.Body>
                        ...
                        <div className="next text-center mt-3">
                            <Button variant="secondary" onClick={() => navigate(`/dashboard`)}>
                                <img src={require("../logos/back.png")} width={30} height={30} alt="Back" />
                            </Button>
                        </div>
                    </Card.Body>
                </Card>
